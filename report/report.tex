...
\add{LDA models a document as a distribution of topics and a topic as a distribution of words. First give an example of topics produced by an LDA model. Next give an example of document representation as a distribution over topics. Say that in your work, a document is a sentence and so a sentence is represented by a distribution of topics.}
...
\add{retrieve forum data following Zhang et al (2015) and Sondhi et al (2010) proposal}
