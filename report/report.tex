...
<<<<<<< HEAD
Here in Table \ref{final_comparision} we provide the comparision of final models taking also in consideration pretrained GloVe and Google News W2V embedding. Among word-base models LDA occured to the best one and was used for word embedding for BiLSTM as described in section \ref{subsec:sentencerepresentations}. Last two models will be used for further steps.
=======
...
>>>>>>> 2ed2b78ea14fbd743e61503e052b4e24519dcb56
